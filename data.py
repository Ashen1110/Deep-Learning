...
COLOR_DICT = np.array(Blood)

# mask change and check
...
def testGenerator(test_path,num_image = 99,target_size = (256,256),as_gray = True):
...
#for label learn *make sure label and train data fit 
